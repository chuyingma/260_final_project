...
data = data %>% 
  dplyr::select( menthlth, black,educ2,income1,income4,married,employed,out_of_work, homemaker,student,hlthplan ,smoke,drink ,genhlth_ex,genhlth_fa ,genhlth_po , qlactlm ,pm2.5)
...
data_all_10 = data_all %>%
  filter(year == 2010) %>%
  mutate(menthlth_hat = predict(mod17, newdata = .))
